...
export const Sparkles: React.FC<IconProps> = (props) => (
  <svg
    ...
    strokeLinejoin="round"
  >
    <path d="m12 3-1.9 1.9a2.5 2.5 0 0 1-3.2 0L3 12l1.9-1.9a2.5 2.5 0 0 1 0-3.2L12 3Z" />
    <path d="M3 21 12 12" />
    <path d="m19 12-1.4-1.4a2.5 2.5 0 0 1 0-3.5L21 3" />
    <path d="M21 21 12 12" />
    <path d="M12 21 10.1 19.1a2.5 2.5 0 0 1-3.2 0L3 12" />
  </svg>
);
